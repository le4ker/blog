...
a few features of the window manager that will be useful:
...
_Note that the above yabai config doesn't require to disable the
[System Integrity Protection](https://en.wikipedia.org/wiki/System_Integrity_Protection)_
