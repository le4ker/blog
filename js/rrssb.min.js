+(function (t, e, i) {
  ...
  e.fn.rrssb = function (t) {
    ...
    (s.emailSubject = s.emailSubject || s.title),
      (s.emailBody =
        s.emailBody ||
    ...
    s.url !== i &&
      ...
      e(this)
        ...
        .attr(
          ...
          "https://www.linkedin.com/shareArticle?mini=true&url=" +
            ...
            (s.description !== i ? "&summary=" + s.description : ""),
        ),
      e(this)
      ...
      e(this)
        ...
        .attr(
          ...
          "https://www.reddit.com/submit?url=" +
            s.url +
            (s.description !== i ? "&text=" + s.description : "") +
            (s.title !== i ? "&title=" + s.title : ""),
        ),
      e(this)
      ...
      (s.emailAddress !== i || s.emailSubject) &&
        e(this)
          .find(".rrssb-email a")
          .attr(
            "href",
            "mailto:" +
              (s.emailAddress ? s.emailAddress : "") +
              "?" +
              (s.emailSubject !== i ? "subject=" + s.emailSubject : "") +
              (s.emailBody !== i ? "&body=" + s.emailBody : ""),
          );
  };
  var r = function () {
      var t = e("<div>"),
    ...
    l = function () {
      e(".rrssb-buttons").each(function (t) {
        ...
        25 * n > s
          ? i.removeClass("small-format").addClass("tiny-format")
      ...
      e(".rrssb-buttons").each(function (t) {
        ...
        if (c === s.length) {
          var h = 42 * c,
            u = i.width();
          u > h + o &&
            (i.removeClass("small-format"), r.eq(0).removeClass("small"), d());
        } else {
      ...
      e(".rrssb-buttons").each(function (t) {
        ...
        u > 0 && u !== d.length
          ? (c.removeClass("small-format"),
            h.css("width", "42px"),
            (n = 42 * u),
            (i = d.not(".small").length),
            (r = 100 / i),
            (o = n / i),
            s.calc === !1
              ? ((l = (c.innerWidth() - 1) / i - o),
                (l = Math.floor(1e3 * l) / 1e3),
                (l += "px"))
              : (l = s.calc + "(" + r + "% - " + o + "px)"),
            d.not(".small").css("width", l))
          : u === d.length
  ...
  e(document).ready(function () {
    try {
      e(document).on("click", ".rrssb-buttons a.popup", {}, function (t) {
        var i = e(this);
        m(i.attr("href"), i.find(".rrssb-text").html(), 580, 470),
          t.preventDefault();
      });
    } catch (i) {}
    e(t).resize(function () {
